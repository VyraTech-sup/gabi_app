/**
 * Dados mock para desenvolvimento (sincronizado com mobile)
 */

import { Program, Episode, User, Notification, ProgramCategory, Review, ProgramRating, MusicTrack } from '../types';
